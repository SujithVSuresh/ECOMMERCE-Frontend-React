...
function ProductScreen() {
                        ...
                        <Card>
                            <ListGroup variant='flush'>
                                ...
                                <ListGroup.Item>
                                    ...
                                    <Button onClick={addToCartHandler} className='btn-block add-to-cart-btn' disabled={product.countInStocks <= 0} type='button'>Add to Cart</Button>
  ...
  //disabled={product.countInStock == 0} - if the condition is true then it is disabled
}
