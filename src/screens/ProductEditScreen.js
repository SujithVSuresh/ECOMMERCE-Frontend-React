    ...
    <FormContainer>
        ...
        {loading ? <Loader /> : error ? <Message variant='danger'>{error}</Message> : (
            ...
            <Form.Group controlId='image'>
                ...
                <Form.Control type="file" className='image-file' label='Choose File' onChange={uploadFileHandler}/>
                {uploading && <Loader/>}
            </Form.Group>
            ...
            <Form.Group controlId='countinstock'>
                ...
                <Form.Control type='number' placeholder='Enter Stock' value={countInStocks} onChange={(e) => setCountInStocks(e.target.value)}></Form.Control>
            </Form.Group>
